...
- **米・イラン合意なら**: VIX<20 + US100 25,000維持確認後に分割限定エントリー開始。
- **US100 25,45x付近「青丸2」レジスタンス**: 突破 or 跳ね返りを確認。月・火買い→水曜売りパターン活用。
- **4/28日銀会合**: 利上げ期待ヘッドラインで円高急落リスク。JPY関連は慎重に。
- **WTI 80$台回帰の有無**: 停戦への市場信頼度の目安として継続監視。
