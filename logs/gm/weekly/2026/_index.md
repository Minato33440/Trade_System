...
## Conventions
- Close basis: FX=NY close / JP=Tokyo close / US=NY close
- MA color rule: Blue=21MA / RedPurple=50MA / Black=200EMA
...
- Links:
  ...
  ### 2026-3-1_wk03（2026-02-24 → 2026-03-01）
- Regime: risk_off_cautious（geopol_persistent + gold_strong_bid / JP_resilience / US_breadth_weak）
- 1行：Gold+3.44%新高・WTI続伸でヘッジ強化、US100-0.42%小反落も23,913守り、JP225+2.61%高値圏で連動乖離。雇用統計前ボラ高・深押し待ち。
- Key gates:
  - Add risk: US100 daily close >24,911 and 21MA holds（押し目のみ／追撃禁止）
  - Reduce risk: US100 daily close <23,913 OR VIX>22定着 OR WTI>70 OR Gold<4,900
- Links:
  - [index](./2026-3-1_wk03/index.md)
  - [note](./2026-3-1_wk03/note.md)
  - [meta](./2026-3-1_wk03/meta.yaml)
  - [review](./2026-3-1_wk03/review.md)
  - [charts](./2026-3-1_wk03/charts/charts.md)
...
- Links:
  - [index](./2026-3-7_wk02/index.md)
  - [note](./2026-3-7_wk02/note.md)
  - [meta](./2026-3-7_wk02/meta.yaml)
  - [review](./2026-3-7_wk02/review.md)
  - [charts](./2026-3-7_wk02/charts/charts.md)

### 2026-3-13_wk03（2026-03-09 → 2026-03-13）
- Regime: risk_off_acceleration（iran_escalation_continues + private_credit_shock_2nd + rate_cut_delay / BOJ_hold / USDJPY_intervention_risk / JP_defense_bid）
- 1行：週初反発も全戻し→週足サポート到達、MS/ブラックロック引き出し制限で信用リスク第2波、USDJPY159.30円で日銀介入リスク水準。FOMC前は完全NO-GO、月末日米首脳会談で防衛継続。
- Key gates:
  - Add risk: 紛争終結確認後US100 23,913維持かつ反発確認（追撃禁止）
  - Reduce risk: US100 daily close <23,913 OR VIX>30定着 OR 紛争拡大（ホルムズ再封鎖等）
- Links:
  - [note](./2026-3-13_wk03/note.md)
